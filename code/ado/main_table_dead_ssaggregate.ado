cap prog drop main_table_dead_ssaggregate
prog def main_table_dead_ssaggregate
	...
	esttab fs_gen_town      ///
		...
		posthead("&\multicolumn{1}{c}{C. Goodman and CoG}\\\cmidrule(lr){2-2}" ///
                "&\multicolumn{1}{c}{Disincorporations and Amalgamations}\\\cmidrule(lr){2-2}" ///
				"&\multicolumn{1}{c}{(1)}\\" ///
				"\cmidrule(lr){1-2}" ///
