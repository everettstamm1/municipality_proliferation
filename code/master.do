...
if `run_dcourt'==1{
	// Setup Derenoncourt files
	do "$CODE/cleaning/dcourt_file_setup.do"

	// Pause and go download the restricted ICPSR data for the CCDB and migration flows per the Derenoncourt replication instructions.
