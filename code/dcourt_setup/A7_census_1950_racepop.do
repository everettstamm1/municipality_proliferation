use "$RAWDATA/census/usa_00085.dta/usa_00085.dta", clear
...
collapse (sum) pop bpop nwhtpop, by(city stateicp)
...
//B4 - 1950 specific xwalk
replace city = "Boise City, ID" if city == "Boise, ID"
replace city = "Arkansas City, KS" if city == "Arkansas, KS"
...
save "$INTDATA/dcourt/census_1950_racepop_cz", replace