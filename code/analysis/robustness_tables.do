...
foreach outcome in cgoodman schdist_ind  gen_subcounty spdist gen_town gen_muni{
	...
	// Column 6: Census Region Controls, blackmig3539_share, and m_rr_sqm2
	...
	local controls  reg2 reg3 reg4 blackmig3539_share pop1940 popc1940 m_rr_sqm2 mfg_lfshare1940 frac_land totfrac_in_main_city mfg_lfshare1940 b_`outcome'_cz1940_pc ln_pop_dens1940 urban_share1940
	qui reg GM_raw_pp GM_hat_raw_pp `controls' [aw=popc1940], r
	test GM_hat_raw_pp=0
	local F : di %6.3f `r(F)'
	qui reg n_`outcome'_cz_pc GM_raw_pp `controls' [aw=popc1940], r
	...
	// Export to tables
			esttab 	using "$TABS/exogeneity_tests/`outcome'_table.tex", ///
							...
							stats(Fstat ols_b ols_r2 N  reg blackmig frac_land totfrac_in_main_city m_rr_sqm2 popc1940 pop1940 mfg_lfshare base dens urban_share, labels( ///
							"First stage F-Stat"	///
							"GM (OLS)" ///
							"R2 (OLS)" ///
							"Observations" ///
