...
eststo A: estpost summarize `panel_A_vars' [aw=popc1940], d 
...
eststo B: estpost summarize `panel_B_vars' [aw=popc1940], d
...
eststo C: estpost summarize `panel_C_vars' [aw=popc1940], d
