...
reg GM_raw_pp GM_hat_raw_pp reg2 reg3 reg4 [aw=popc1940], r
	...
	binscatter GM_raw_pp GM_hat_raw_pp  [aw=popc1940], controls(reg2 reg3 reg4) ///
...
foreach outcome in cgoodman schdist_ind gen_subcounty spdist{
	...
	reg n_`outcome'_cz_pcc GM_hat_raw_pp reg2 reg3 reg4 [aw=popc1940], r
	local coef : di %6.3f _b[GM_hat_raw_pp]
	local se : di %6.3f _se[GM_hat_raw_pp]
	...
	qui su GM_hat_raw_pp, d
	local xcord = `r(mean)'*2
	binscatter n_`outcome'_cz_pcc GM_hat_raw_pp  [aw=popc1940], controls(reg2 reg3 reg4) ///
...
foreach outcome in cgoodman schdist_ind gen_subcounty spdist{
	...
	reg n_`outcome'_cz_pcc GM_raw_pp reg2 reg3 reg4 [aw=popc1940], r
	...
	qui su GM_raw_pp, d
	local xcord = `r(mean)'*2
	binscatter n_`outcome'_cz_pcc GM_raw_pp  [aw=popc1940], controls(reg2 reg3 reg4) ///
									xtitle("Predicted PP Black Migrant") ytitle("`outcome'") ///
...
reg GM_raw GM_hat_raw reg2 reg3 reg4 [aw=popc1940], r
	...
	qui su GM_hat_raw, d
	local xcord = `r(mean)'*2
	binscatter GM_raw GM_hat_raw  [aw=popc1940], controls(reg2 reg3 reg4) ///
