// condensed 2sls tables
foreach inst in full og{
	forv weight=0/1{
		forv pc=0/1{
			foreach ds in schdist_ind gen_muni all_local_nosch{
				...
				use "$CLEANDATA/cz_`ds'_stacked_`inst'.dta", clear
				...
				esttab 	using "$TABS/shorttables/shorttables_`pc'_`weight'_`ds'_`inst'.tex", ///
