...
foreach var in 10 20 30 40{
	if "`var'" != "10" local y1 = `var'-10
	if "`var'" == "10" local y1 = "00"
	
	su b19`y1'_cgoodman_cz_pc
...
esttab n10 n20 n30 n40  ///
				...
				prehead( \begin{tabularx}{\linewidth}{l*{4}{>{\centering\arraybackslash}X}} \toprule) postfoot(	\bottomrule \end{tabularx}) stats(basemean basesd N ctrls, labels( "Baseline Controls" "Baseline Std Dev" "Observations" "Balance Controls") fmt(2 2 0))
