...
foreach y in schdist_ind cgoodman{
	...
	// Create PC outcome
	g n_`y'_cz_pc = b_`y'_cz1970/(popc1970/1000) - b_`y'_cz1940/(popc1940/1000)
...
foreach y in schdist_ind cgoodman{
	...
	g frac = b_`y'_cz/pop
	g fracc = b_`y'_cz/popc
	
	bys cz (decade) : g n_`y'_cz_L0_pc = frac[_n+1] - frac
	bys cz (decade) : g n_`y'_cz_L0_pcc = fracc[_n+1] - fracc
