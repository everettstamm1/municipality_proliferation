			...
			forv ctrls=3/3{
				...
				foreach pop in raw pc{ 
					...
					esttab 	fs ///
									...
									rf	///
									tsls ///
									using "$TABS/simpletables/pooled_`y'_`pop'_C`ctrls'_`samp'_above", ///
									replace label nomtitles se booktabs num noconstant ///
									starlevels( * 0.10 ** 0.05 *** 0.01) ///
									stats(Fstat N, labels( ///
									"F-Stat"	///
			...
			forv ctrls=3/3{
				...
				foreach pop in raw pc{ 
					...
					esttab 	fs ///
									...
									rf	///
									tsls ///
									using "$TABS/simpletables/stacked_`y'_`pop'_C`ctrls'_`samp'_above", ///
									replace label se booktabs num noconstant nomtitles ///
									starlevels( * 0.10 ** 0.05 *** 0.01) ///
									stats(Fstat N, labels( ///
									"F-Stat"	///
			...
			forv ctrls=3/3{
				...
				foreach pop in raw pc{ 
					...
					esttab 	fs ///
									...
									rf	///
									tsls ///
									using "$TABS/simpletables/pooled_`y'_`pop'_C`ctrls'_`samp'_below", ///
									replace label nomtitles se booktabs num noconstant ///
									starlevels( * 0.10 ** 0.05 *** 0.01) ///
									stats(Fstat N, labels( ///
									"F-Stat"	///
			...
			forv ctrls=3/3{
				...
				foreach pop in raw pc{ 
					...
					esttab 	fs ///
									...
									rf	///
									tsls ///
									using "$TABS/simpletables/stacked_`y'_`pop'_C`ctrls'_`samp'_below", ///
									replace label se booktabs num noconstant nomtitles ///
									starlevels( * 0.10 ** 0.05 *** 0.01) ///
									stats(Fstat N, labels( ///
									"F-Stat"	///
