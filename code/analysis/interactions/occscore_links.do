...
g y = .
	ivreg2 n_cgoodman_cz_pc (x x_int = z z_int) reg2 reg3 reg4 mfg_lfshare1940 cz_popdens1940 mean_income_1940 sumshare_base sumshare_base_int above_med_occscore_3040 [aw = popc1940],r first
...
file open fh using "$TABS/occscore_links_interaction.tex", write replace
