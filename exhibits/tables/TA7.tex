...
\cmidrule(lr){1-6}
GM              &    0.001   &    0.003   &    0.096** &    0.001   &   -0.723***\\
                &  (0.002)   &  (0.003)   &  (0.043)   &  (0.009)   &  (0.161)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel C: 2SLS 1950-1970}\\
\cmidrule(lr){1-6}
GM              &    0.002   &    0.004** &    0.176***&    0.004   &   -1.377***\\
                &  (0.002)   &  (0.002)   &  (0.038)   &  (0.005)   &  (0.081)   \\
\midrule
1950-70 Avg.    &    -0.15   &    -0.18   &    -7.06   &     0.45   &    -2.47   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel D: OLS 1950-2010}\\
\cmidrule(lr){1-6}
GM              &    0.003   &    0.004   &    0.096** &   -0.001   &   -0.947***\\
                &  (0.003)   &  (0.004)   &  (0.043)   &  (0.008)   &  (0.208)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel E: 2SLS 1950-2010}\\
\cmidrule(lr){1-6}
GM              &    0.005** &    0.005*  &    0.177***&    0.013** &   -1.661***\\
                &  (0.002)   &  (0.003)   &  (0.039)   &  (0.006)   &  (0.122)   \\
\cmidrule(lr){1-6}
