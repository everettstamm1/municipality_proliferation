...
\cmidrule(lr){1-5}
$\hat{GM}$      &    1.479***&    1.468***&    1.665***&    1.709***\\
                &  (0.312)   &  (0.308)   &  (0.297)   &  (0.307)   \\
\cmidrule(lr){1-5}
\multicolumn{4}{l}{Panel B: OLS 1940-1970}\\
\cmidrule(lr){1-5}
GM              &    0.016***&    0.016***&    0.055***&    0.037*  \\
                &  (0.006)   &  (0.006)   &  (0.016)   &  (0.021)   \\
\cmidrule(lr){1-5}
\multicolumn{4}{l}{Panel C: 2SLS 1940-1970}\\
\cmidrule(lr){1-5}
GM              &    0.014   &    0.017*  &    0.011   &    0.033   \\
