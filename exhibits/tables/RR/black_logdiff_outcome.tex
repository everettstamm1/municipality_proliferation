...
\cmidrule(lr){1-6}
$\widehat{GM}$  &    1.771***&    1.771***&    1.841***&    1.761***&    1.771***\\
                &  (0.315)   &  (0.315)   &  (0.330)   &  (0.326)   &  (0.315)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel B: OLS 1940-1970}\\
\cmidrule(lr){1-6}
GM              &    0.003   &    0.005   &    0.005   &    0.004   &   -0.019***\\
                &  (0.003)   &  (0.003)   &  (0.017)   &  (0.020)   &  (0.005)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel C: 2SLS 1940-1970}\\
\cmidrule(lr){1-6}
GM              &    0.001   &    0.005   &   -0.031***&    0.003   &   -0.029***\\
                &  (0.002)   &  (0.003)   &  (0.009)   &  (0.008)   &  (0.002)   \\
\midrule
1940-70 Avg.    &     0.13   &     0.08   &    -1.80   &     1.15   &    -0.14   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel D: OLS 1940-2010}\\
\cmidrule(lr){1-6}
GM              &    0.003   &    0.000   &    0.003   &   -0.017   &   -0.019***\\
                &  (0.003)   &  (0.005)   &  (0.017)   &  (0.018)   &  (0.005)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel E: 2SLS 1940-2010}\\
\cmidrule(lr){1-6}
GM              &   -0.001   &    0.000   &   -0.036***&   -0.023** &   -0.029***\\
                &  (0.003)   &  (0.004)   &  (0.010)   &  (0.011)   &  (0.002)   \\
\cmidrule(lr){1-6}
1940-2010 Avg.  &     0.18   &     0.12   &    -1.92   &     1.71   &    -0.14   \\
1940 Avg.       &     1.49   &     1.61   &    14.09   &     0.89   &    32.86   \\
First Stage F-Stat&    31.55   &    31.55   &    31.18   &    29.19   &    31.55   \\
