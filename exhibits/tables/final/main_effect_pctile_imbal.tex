...
\cmidrule(lr){1-6}
Percentile $\widehat{GM}$&    0.549***&    0.549***&    0.426***&    0.549***&    0.549***\\
                &  (0.118)   &  (0.118)   &  (0.116)   &  (0.118)   &  (0.118)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel B: OLS 1940-1970}\\
\cmidrule(lr){1-6}
Percentile GM   &   -0.001   &    0.000   &    0.108***&   -0.010***&   -0.165***\\
                &  (0.001)   &  (0.001)   &  (0.035)   &  (0.002)   &  (0.054)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel C: 2SLS 1940-1970}\\
\cmidrule(lr){1-6}
Percentile GM   &    0.002   &    0.002   &    0.308***&   -0.012***&   -0.331***\\
                &  (0.002)   &  (0.002)   &  (0.100)   &  (0.005)   &  (0.105)   \\
\midrule
1940-70 Avg.    &    -0.26   &    -0.33   &   -12.91   &     0.64   &    -3.31   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel D: OLS 1940-2010}\\
\cmidrule(lr){1-6}
Percentile GM   &    0.001   &    0.003   &    0.110***&   -0.018***&   -0.255***\\
                &  (0.001)   &  (0.002)   &  (0.035)   &  (0.003)   &  (0.077)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel E: 2SLS 1940-2010}\\
\cmidrule(lr){1-6}
Percentile GM   &    0.005*  &    0.006** &    0.314***&   -0.017***&   -0.442***\\
                &  (0.003)   &  (0.003)   &  (0.101)   &  (0.006)   &  (0.133)   \\
\cmidrule(lr){1-6}
1940-2010 Avg.  &    -0.39   &    -0.49   &   -13.27   &     1.05   &    -7.88   \\
1940 Avg.       &     1.48   &     1.61   &    14.05   &     0.88   &    32.78   \\
First State F-Stat&    21.45   &    21.45   &    13.42   &    21.45   &    21.45   \\
