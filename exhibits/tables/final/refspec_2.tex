...
\cmidrule(lr){1-6}
GM              &   -0.000   &    0.002   &    0.096   &   -0.001   &   -1.156***\\
                &  (0.002)   &  (0.003)   &  (0.076)   &  (0.015)   &  (0.394)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel C: 2SLS 1940-1970}\\
\cmidrule(lr){1-6}
GM              &    0.001   &    0.006** &    0.158** &    0.052***&   -3.137***\\
                &  (0.002)   &  (0.002)   &  (0.068)   &  (0.014)   &  (0.353)   \\
\midrule
1940-70 Avg.    &     0.16   &     0.11   &   -12.38   &     1.40   &    17.19   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel D: OLS 1940-2010}\\
\cmidrule(lr){1-6}
GM              &   -0.001   &    0.000   &    0.094   &    0.003   &   -2.260***\\
                &  (0.003)   &  (0.004)   &  (0.077)   &  (0.023)   &  (0.780)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel E: 2SLS 1940-2010}\\
\cmidrule(lr){1-6}
GM              &    0.001   &    0.004   &    0.151** &    0.114***&   -6.640***\\
                &  (0.003)   &  (0.003)   &  (0.068)   &  (0.029)   &  (0.994)   \\
\cmidrule(lr){1-6}
