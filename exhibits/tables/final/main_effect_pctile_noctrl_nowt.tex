...
\cmidrule(lr){1-6}
Percentile $\widehat{GM}$&    0.740***&    0.740***&    0.696***&    0.740***&    0.740***\\
                &  (0.083)   &  (0.083)   &  (0.103)   &  (0.083)   &  (0.083)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel B: OLS 1940-1970}\\
\cmidrule(lr){1-6}
Percentile GM   &    0.000   &    0.001   &    0.169***&   -0.012***&   -0.226***\\
                &  (0.001)   &  (0.001)   &  (0.025)   &  (0.003)   &  (0.046)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel C: 2SLS 1940-1970}\\
\cmidrule(lr){1-6}
Percentile GM   &    0.001   &    0.002*  &    0.246***&   -0.010***&   -0.292***\\
                &  (0.001)   &  (0.001)   &  (0.040)   &  (0.003)   &  (0.055)   \\
\midrule
1940-70 Avg.    &    -0.26   &    -0.33   &   -12.91   &     0.64   &    -3.31   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel D: OLS 1940-2010}\\
\cmidrule(lr){1-6}
Percentile GM   &    0.002** &    0.004***&    0.173***&   -0.018***&   -0.304***\\
                &  (0.001)   &  (0.001)   &  (0.025)   &  (0.003)   &  (0.060)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel E: 2SLS 1940-2010}\\
\cmidrule(lr){1-6}
Percentile GM   &    0.004***&    0.005***&    0.253***&   -0.013***&   -0.394***\\
                &  (0.001)   &  (0.002)   &  (0.041)   &  (0.004)   &  (0.073)   \\
\cmidrule(lr){1-6}
1940-2010 Avg.  &    -0.39   &    -0.49   &   -13.27   &     1.05   &    -7.88   \\
1940 Avg.       &     1.48   &     1.61   &    14.05   &     0.88   &    32.78   \\
First State F-Stat&    78.85   &    78.85   &    45.75   &    78.85   &    78.85   \\
