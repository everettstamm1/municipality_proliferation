...
\cmidrule(lr){1-6}
$\widehat{GM}$  &    1.887***&    1.887***&    2.086***&    1.887***&    1.887***\\
                &  (0.331)   &  (0.331)   &  (0.353)   &  (0.331)   &  (0.331)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel B: OLS 1940-1970}\\
\cmidrule(lr){1-6}
GM              &    0.003   &    0.005   &    0.106   &   -0.005   &   -0.895***\\
                &  (0.003)   &  (0.004)   &  (0.078)   &  (0.010)   &  (0.173)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel C: 2SLS 1940-1970}\\
\cmidrule(lr){1-6}
GM              &    0.010***&    0.014***&    0.128** &   -0.000   &   -1.557***\\
...
\cmidrule(lr){1-6}
GM              &    0.005   &    0.006   &    0.106   &   -0.008   &   -1.146***\\
                &  (0.005)   &  (0.005)   &  (0.079)   &  (0.008)   &  (0.217)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel E: 2SLS 1940-2010}\\
\cmidrule(lr){1-6}
GM              &    0.013***&    0.015***&    0.131** &    0.013** &   -1.764***\\
                &  (0.003)   &  (0.004)   &  (0.066)   &  (0.006)   &  (0.117)   \\
\cmidrule(lr){1-6}
1940-2010 Avg.  &    -0.39   &    -0.49   &   -13.27   &     1.05   &    -7.88   \\
1940 Avg.       &     1.48   &     1.61   &    14.05   &     0.88   &    32.78   \\
First Stage F-Stat&    32.44   &    32.44   &    34.87   &    32.44   &    32.44   \\
