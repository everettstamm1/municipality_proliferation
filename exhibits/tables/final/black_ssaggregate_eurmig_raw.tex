...
\cmidrule(lr){1-6}
$\widehat{GM}$  &    1.714***&    1.714***&    1.758***&    1.714***&    1.714***\\
                &  (0.312)   &  (0.312)   &  (0.339)   &  (0.312)   &  (0.312)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel B: OLS 1940-1970}\\
\cmidrule(lr){1-6}
GM              &    0.002   &    0.003   &    0.103   &   -0.007   &   -0.799***\\
                &  (0.003)   &  (0.004)   &  (0.070)   &  (0.009)   &  (0.148)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel C: 2SLS 1940-1970}\\
\cmidrule(lr){1-6}
GM              &    0.005** &    0.008***&    0.189** &    0.010   &   -1.448***\\
                &  (0.002)   &  (0.003)   &  (0.078)   &  (0.006)   &  (0.090)   \\
\midrule
1940-70 Avg.    &    -0.26   &    -0.33   &   -12.91   &     0.64   &    -3.31   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel D: OLS 1940-2010}\\
\cmidrule(lr){1-6}
GM              &    0.004   &    0.004   &    0.103   &   -0.009   &   -1.002***\\
                &  (0.005)   &  (0.005)   &  (0.071)   &  (0.008)   &  (0.166)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel E: 2SLS 1940-2010}\\
\cmidrule(lr){1-6}
GM              &    0.007** &    0.008** &    0.189** &    0.021***&   -1.664***\\
                &  (0.003)   &  (0.004)   &  (0.079)   &  (0.006)   &  (0.130)   \\
\cmidrule(lr){1-6}
1940-2010 Avg.  &    -0.39   &    -0.49   &   -13.27   &     1.05   &    -7.88   \\
1940 Avg.       &     1.48   &     1.61   &    14.05   &     0.88   &    32.78   \\
First Stage F-Stat&    30.25   &    30.25   &    26.96   &    30.25   &    30.25   \\
