...
\cmidrule(lr){1-6}
WM              &   -0.005** &   -0.005** &   -0.080   &   -0.000   &    0.573***\\
                &  (0.002)   &  (0.002)   &  (0.066)   &  (0.007)   &  (0.182)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel C: 2SLS 1940-1970}\\
\cmidrule(lr){1-6}
WM              &   -0.053** &   -0.074***&    0.372*  &    0.003   &    1.114** \\
                &  (0.021)   &  (0.029)   &  (0.224)   &  (0.023)   &  (0.461)   \\
\midrule
1940-70 Avg.    &    -0.26   &    -0.33   &   -12.91   &     0.64   &    -3.28   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel D: OLS 1940-2010}\\
\cmidrule(lr){1-6}
WM              &   -0.008** &   -0.008** &   -0.080   &   -0.008   &    0.700** \\
                &  (0.003)   &  (0.004)   &  (0.067)   &  (0.010)   &  (0.292)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel E: 2SLS 1940-2010}\\
\cmidrule(lr){1-6}
WM              &   -0.069***&   -0.088***&    0.354   &   -0.086** &    1.240** \\
                &  (0.027)   &  (0.033)   &  (0.226)   &  (0.044)   &  (0.488)   \\
\cmidrule(lr){1-6}
