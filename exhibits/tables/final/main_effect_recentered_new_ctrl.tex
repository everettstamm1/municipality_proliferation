...
\cmidrule(lr){1-7}
$\widehat{GM}$, recentered&    2.963***&    2.963***&    2.963***&    2.963***&    2.963***&    2.963***\\
                &  (0.383)   &  (0.383)   &  (0.383)   &  (0.383)   &  (0.383)   &  (0.383)   \\
\cmidrule(lr){1-7}
\multicolumn{6}{l}{Panel B: OLS}\\
\cmidrule(lr){1-7}
GM, recentered  &    0.006** &    0.008***&    0.127   &    0.017***&   -0.035***&   -1.137***\\
                &  (0.003)   &  (0.003)   &  (0.085)   &  (0.005)   &  (0.008)   &  (0.126)   \\
\cmidrule(lr){1-7}
\multicolumn{6}{l}{Panel C: Reduced Form}\\
\cmidrule(lr){1-7}
$\widehat{GM}$, recentered&    0.039***&    0.052***&    0.947** &    0.108***&   -0.091** &   -4.929***\\
                &  (0.014)   &  (0.017)   &  (0.390)   &  (0.028)   &  (0.036)   &  (0.670)   \\
\cmidrule(lr){1-7}
\multicolumn{6}{l}{Panel D: 2SLS}\\
\cmidrule(lr){1-7}
GM, recentered  &    0.013***&    0.017***&    0.320** &    0.036***&   -0.031***&   -1.663***\\
