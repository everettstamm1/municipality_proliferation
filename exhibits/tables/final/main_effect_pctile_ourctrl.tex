...
\cmidrule(lr){1-6}
Percentile $\widehat{GM}$&    0.439***&    0.439***&    0.307***&    0.439***&    0.439***\\
                &  (0.118)   &  (0.118)   &  (0.115)   &  (0.118)   &  (0.118)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel B: OLS 1940-1970}\\
\cmidrule(lr){1-6}
Percentile GM   &   -0.002** &   -0.001   &    0.040   &   -0.006*  &   -0.091   \\
                &  (0.001)   &  (0.001)   &  (0.034)   &  (0.003)   &  (0.070)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel C: 2SLS 1940-1970}\\
\cmidrule(lr){1-6}
Percentile GM   &   -0.000   &   -0.000   &    0.261** &    0.005   &   -0.299** \\
...
\cmidrule(lr){1-6}
Percentile GM   &   -0.002   &   -0.001   &    0.039   &   -0.010***&   -0.158   \\
                &  (0.001)   &  (0.002)   &  (0.035)   &  (0.004)   &  (0.103)   \\
\cmidrule(lr){1-6}
\multicolumn{5}{l}{Panel E: 2SLS 1940-2010}\\
\cmidrule(lr){1-6}
Percentile GM   &    0.002   &    0.002   &    0.265** &    0.009   &   -0.446***\\
                &  (0.003)   &  (0.003)   &  (0.113)   &  (0.011)   &  (0.161)   \\
\cmidrule(lr){1-6}
1940-2010 Avg.  &    -0.39   &    -0.49   &   -13.27   &     1.05   &    -7.88   \\
1940 Avg.       &     1.48   &     1.61   &    14.05   &     0.88   &    32.78   \\
First State F-Stat&    13.89   &    13.89   &     7.09   &    13.89   &    13.89   \\
