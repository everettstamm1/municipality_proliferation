...
\section{Land Use}
\input{tables/land_use_index/samp_full_weight_none.tex}
\clearpage
\input{tables/land_use_index/samp_full_weight_full.tex}
\clearpage
\input{tables/land_use_index/samp_full_weight_metro.tex}
\clearpage
\input{tables/land_use_index/samp_full_pre_weight_none.tex}
\clearpage
\input{tables/land_use_index/samp_full_pre_weight_full.tex}
\clearpage
\input{tables/land_use_index/samp_full_pre_weight_metro.tex}
\clearpage
\input{tables/land_use_index/samp_nonsouthern_weight_none.tex}
\clearpage
\input{tables/land_use_index/samp_nonsouthern_weight_full.tex}
\clearpage
\input{tables/land_use_index/samp_nonsouthern_weight_metro.tex}
\clearpage
\input{tables/land_use_index/samp_nonsouthern_pre_weight_none.tex}
\clearpage
\input{tables/land_use_index/samp_nonsouthern_pre_weight_full.tex}
\clearpage
\input{tables/land_use_index/samp_nonsouthern_pre_weight_metro.tex}
\clearpage
...
\begin{landscape}
\input{tables/gp/gp_cz_pooled_urban.tex}
\clearpage
\input{tables/gp/gp_cz_pooled_total.tex}
\clearpage
\input{tables/gp/gp_cz_stacked_urban.tex}
\clearpage
\input{tables/gp/gp_cz_stacked_total.tex}
\clearpage
\end{landscape}
